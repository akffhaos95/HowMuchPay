...
class MenuAdapter(val context: Context, val menu_List: LiveData<Db_menu_Entity>, val itemClick: (Db_menu_Entity) -> Unit, val delClick: (Db_menu_Entity) -> Unit) :
    ...
    fun setData(newData: List<Db_menu_Entity?>) {
        val data = newData
